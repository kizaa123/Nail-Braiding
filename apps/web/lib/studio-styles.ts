...
export function upsertStudioStyle(draft: StyleDraft) {
...
export function patchStudioStyle(id: string, patch: Partial<StudioStyle>) {
...
export function archiveStudioStyle(id: string) {
  patchStudioStyle(id, { archived: true, published: false });
}

export function restoreStudioStyle(id: string) {
  patchStudioStyle(id, { archived: false });
}

export function deleteStudioStyle(id: string) {
